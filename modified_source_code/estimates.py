...
class Estimates(object):
    ...
    def plot_contours(self, img=None, idx=None, thr_method='max',
        ...
        return self
    def plot_only_contours(self, img=None, idx=None, thr_method='max',
                      thr=0.2, display_numbers=None,params=None,
                      cmap='viridis'):
        """view contours of all spatial footprints.
        ...
        if idx is None:
            ...
            caiman.utils.visualization.plot_contours(self.A[:, bad], img,coordinates=coor_b,display_numbers=display_numbers)
            plt.title('Rejected Components')
        return self	
    def plot_only_accept(self, img=None, idx=None, thr_method='max',
                      thr=0.2, display_numbers=None,params=None,
                      cmap='viridis'):
        """view contours of all spatial footprints.
        ...
        if idx is None:
            ...
            bad = list(set(range(self.A.shape[1])) - set(idx))
        return self
    def plot_only_reject(self, img=None, idx=None, thr_method='max',
                      thr=0.2, display_numbers=None,params=None,
                      cmap='viridis'):
        """view contours of all spatial footprints.
